            ...
            <div class="auth-form">
				<div class="auth-form__container">
					<div class="auth-form__header">
						...
						<a href="Đăng Ký.php" class="auth-form__switch-btn" style="text-decoration: none;">Đăng ký</a>
					</div>
					<form action="login_submit.php" method="POST">
						<div class="auth-form__form">
							<div class="auth-form__group">
								<input type="text" class="auth-form__input"  name="username" required="" placeholder="Nhập tài khoản">
							</div>
							<div class="auth-form__group">
								<input type="password" class="auth-form__input" name="password" required="" placeholder="Nhập mật khẩu">
							</div>						
						</div>
