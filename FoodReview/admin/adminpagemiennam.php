...
<body>
  <section id="container">
    ...
    <?php
    	...
    	$query = "SELECT * FROM pagemiennam";
    	$stmt = $connection->prepare($query);
        $stmt->execute();
        $pagemiennam = $stmt->fetchAll();
        
    ?>
      <div class="row">
      <div class="border-head" style="padding-top: 80px; text-align:center;">
          <h3 style="color: red;font-size: 23px;font-weight: 600;">Quản lý bài viết Miền Nam</h3>
      </div>
      ...
      <table>
          ...
          <th>Price</th>
            ...
            <td><?php echo $u['price'];?></td>
						...
						<td><a style="text-decoration: none; text-align:center;" href="update-pagemiennam.php?id=<?php echo $u['id']?>">Sửa</a></td>
						<td><a style="text-decoration: none; text-align:center;" href="delete-pagemiennam.php?id=<?php echo $u['id']?>">Xóa</a></td>
					</tr>
					<?php endforeach?>
			</tbody>
		</table
      ...
      <form action="save-addpagemiennam.php" method="POST">
        <div>
