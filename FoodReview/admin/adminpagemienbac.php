  ...
  <section id="container">
    ...
    <div class="container" id="main-content">
      <?php
    	  ...
    	  $query = "SELECT * FROM pagemienbac";
    	  $stmt = $connection->prepare($query);   
        $stmt->execute();
        $pagemienbac = $stmt->fetchAll();
        
      ?>
      <div class="row">
        <div class="border-head" style="padding-top: 80px; text-align:center;">
          <h3 style="color: red;font-size: 23px;font-weight: 600;">Quản lý bài viết Miền Bắc</h3>
        </div>
        ...
        <table>
              ...
              <th>Price</th>
                ...
                <td><?php echo $u['price'];?></td>
						    ...
						    <td><a style="text-decoration: none; text-align:center;" href="update-pagemienbac.php?id=<?php echo $u['id']?>">Sửa</a></td>
						    <td><a style="text-decoration: none; text-align:center;" href="delete-pagemienbac.php?id=<?php echo $u['id']?>">Xóa</a></td>
					    </tr>
					  <?php endforeach?>
			    </tbody>
		    </table
        <div class="border-head" style="padding-top: 80px; text-align:center;">
          <h3 style="color: red;font-size: 23px;font-weight: 600;">Thêm bài viết</h3>
        </div>
        <form action="save-addpagemienbac.php" method="POST">
          <div>
