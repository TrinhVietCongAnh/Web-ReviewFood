  ...
  <section id="container">
    ...
    <div class="container" id="main-content">
      ...
      <div class="border-head" style="padding-top: 80px; text-align:center;">
          <h3 style="color: red;font-size: 23px;font-weight: 600;">Quản lý người dùng</h3>
      </div>
			  ...
			  <tbody class="gach">
				  <?php foreach($user as $u):?>
					<tr>
						...
						<td><a style="text-decoration: none; text-align:center;" href="adminuser-update.php?id=<?php echo $u['id']?>">Sửa</a></td>
						<td><a style="text-decoration: none; text-align:center;" href="delete-user.php?id=<?php echo $u['id']?>">Xóa</a></td>
					</tr>
					<?php endforeach?>
			  </tbody>
		  </table>
      <div class="border-head" style="padding-top: 80px; text-align:center;">
          <h3 style="color: red;font-size: 23px;">Thêm người dùng</h3>
      </div>
      <form action="save-add.php" method="POST">
        ...
        <div>
            <input type="text" name="password" id="" placeholder="Nhập Password">
        </div>
        <div>
