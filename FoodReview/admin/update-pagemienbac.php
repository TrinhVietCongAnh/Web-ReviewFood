  ...
  <section id="container">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li><a href="adminbaiviet.php">Bài viết</a></li>
    ...
    <div class="row">
      <div class="border-head" style="padding-top: 80px; text-align:center;">
          <h3 style="color: red;font-size: 23px;font-weight: 600;">Update bài viết miền Bắc</h3>
      </div>
      <?php
        $id = $_GET['id'];
        // echo $id;
        $connection = new PDO("mysql:host=127.0.0.1;dbname=vidu;charset=utf8","root","");
        $query = "SELECT * FROM pagemienbac where id=$id";
        ...
        // var_dump($user);
    ?>
	<form action="save-updatepagemienbac.php" method="POST">
        <div>
