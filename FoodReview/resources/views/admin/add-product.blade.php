                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="{{ URL::to('/save-product') }}" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="product_desc" style="resize: none" id="exampleInputPassword1" rows="8" class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Nội dung sản phẩm </label>
                            <textarea name="product_content" style="resize: none" id="exampleInputPassword1" rows="8" class="form-control"></textarea>
                        </div>
