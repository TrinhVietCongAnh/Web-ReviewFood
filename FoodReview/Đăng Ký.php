        ...
        <header class="header">
			<div class="grid wide">
				...
				<div class="header__notify">
					...
					<li href="" class="header__navbar-item header__navbar-item--strong">Đăng ký</li>
					<font color="white" size="5"> | </font>
				...
				<div class="header-with-search">
					...
					<nav class="header__mobile">
						...
						<ul class="header__mobile-list">
							<li>
								<a href="Đăng Ký.html" class="header__mobile-link">Đăng ký</a>
							</li>
							<li>
								<a href="Đăng Nhập.html" class="header__mobile-link">Đăng nhập</a>
							</li>
							<li>
					...
					<div class="header__logo">
						<a href="GoFood.html" class="header__logo-link">
									...
									<li class="header__cart-item">
										<div class="header__cart-item-info">
											<div class="header__cart-item-head">
												<a class="header__cart-item-name" href="">Miền Bắc</a>
											</div>
										</div>
									</li>
									<li class="header__cart-item">
										<div class="header__cart-item-info">
											<div class="header__cart-item-head">
												<a class="header__cart-item-name"  href="">Miền Trung</a>
											</div>
										</div>
									</li>
									<li class="header__cart-item">
										<div class="header__cart-item-info">
											<div class="header__cart-item-head">
												<a class="header__cart-item-name"  href="">Miền Nam</a>
											</div>
										</div>
									</li>
								</ul>
			...
			<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img src="https://scontent.xx.fbcdn.net/v/t1.15752-9/263331621_1128091971296792_5738915994279814452_n.png?_nc_cat=111&ccb=1-5&_nc_sid=aee45a&_nc_ohc=m6-G_27CEm0AX9nKI1O&_nc_ad=z-m&_nc_cid=0&_nc_ht=scontent.xx&oh=b8e47e0d3548a0b43d60202900bae0ea&oe=61CC5D3C" class="d-block w-100" alt="..." style="width:100%;">
					</div>
				</div>
			</div>
	</div>
		...
		<div class="grid">
			<div class="row sm-gutter">
				...
				<div class="col l-2-4 m-4 c-6">
					...
					<ul class="footer-list">
						<li class="footer-item">
							<a href="" class="footer-item__link">Giới thiệu về VN Food</a>
						</li>
						<li class="footer-item">
            ...
            <div class="auth-form">
				<div class="auth-form__container">
					<div class="auth-form__header">
						...
						<a href="Đăng Nhập.php" class="auth-form__switch-btn" style="text-decoration: none;">Đăng nhập</a>
					</div>
					<form action="register_submit.php" method="POST">
						<div class="auth-form__form">
							<div class="auth-form__group">
							<input type="text" class="auth-form__input" name="username" placeholder="Nhập tài khoản" required="">
							</div>
							<div class="auth-form__group">
							<input type="password" class="auth-form__input" name="password" placeholder="Nhập mật khẩu" required="">
							</div>
							<div class="auth-form__group">
							<input type="password" class="auth-form__input" name="repassword" placeholder="Nhập lại mật khẩu" required="">
							</div>						
						</div>
	
						<div class="auth-form__aside">
							<p class="auth-form__policy-text">Bằng việc đăng ký, bạn đã đồng ý với VN Food về
								<a href="Giới Thiệu Web.php" class="auth-form__text-link">Điều khoản dịch vụ</a> & 
								<a href="Giới Thiệu Web.php" class="auth-form__text-link">Chính sách bảo mật</a>
							</p>
						</div>
	
						<div class="auth-form__controls">
							<a href="index.php" class="btn btn--nomal auth-form__controls-back">TRỞ LẠI</a>
					...
					<div class="auth-form__socials">
						<a href="https://www.facebook.com/" class="auth-form__socials--facebook btn btn--size-s btn--with-icon">
							<i class="auth-form__socials-icon fab fa-facebook-square"></i>
							<span class="auth-form__socials-title">
								Kết nối với Facebook
							</span>
						</a>
						<a href="https://accounts.google.com/ServiceLogin/signinchooser?elo=1&flowName=GlifWebSignIn&flowEntry=ServiceLogin" class="auth-form__socials--google btn btn--size-s btn--with-icon">
							<i class="auth-form__socials-icon fab fa-google"></i>
							<span class="auth-form__socials-title auth-form__socials-title2">
								Kết nối với Google
							</span>
						</a>
					</div>
