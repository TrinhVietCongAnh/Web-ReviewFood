							...
							<div class="header__cart-list header__cart-list--no-cart">
								<ul class="header__cart-list-item">
									...
									<li class="header__cart-item">
										<div class="header__cart-item-info">
											<div class="header__cart-item-head">
												<a  href="#" class="header__cart-item-name"  href="">Miền Nam</a>
											</div>
										</div>
									</li>
								</ul>
					...
					<div  class="col l-10 m-12 c-12">
						...
						<div class="home-product">
							<div class="row sm-gutter">
								...
								$sqlmiennam = 'select count(id) as number from pagemiennam' .$additional;
								$result = excuteResultMienNam($sqlmiennam);
								$number = 0;
								...
								$sqlmiennam = 'select * from pagemiennam where 1 '.$additional.' limit '.$index.', 15';
								$result = excuteResultMienNam($sqlmiennam);
								foreach ($result as $pagemiennam){
									echo '<a href="PageMienNam.php?id='.$pagemiennam['id'].'" class="col l-2-4 m-4 c-6">
									<div class="home-product-item">
									<img src="'.$pagemiennam['image'].'"class="home-product-item__img">
									<h4 class="home-product-item__name">'.$pagemiennam['title'].'</h4>
									<h5 class="home-product-item__location">'.$pagemiennam['introduce'].'</h5>
									<div class="home-product-item__action">
										<span class="home-product-item__like home-product-item__like--liked" style="color: #ff0b0b; font-weight: 500;">
											'.$pagemiennam['location'].'
										</span>
										<div class="home-product-item__rating">
											<i class="home-product-item__star--gold"></i>
										</div>
										<span class="home-product-item__sold">'.$pagemiennam['username'].'</span>
									</div>
									</div>
								</a>';
								}
