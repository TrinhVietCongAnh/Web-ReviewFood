									...
									<li class="header__cart-item">
										<div class="header__cart-item-info">
											<div class="header__cart-item-head">
												<a href="#" class="header__cart-item-name" href="">Miền Bắc</a>
											</div>
										</div>
									</li>
									<li class="header__cart-item">
                    ...
                    <div class="col l-2 m-0 c-0">
						<nav class="category">
							...
							<ul class="category-list">
								...
								<li class="category-item">
									<a href="" class="category-item__link">Hòa Bình</a>
								</li>
                                <li class="category-item">
					...
					<div  class="col l-10 m-12 c-12">
						...
						<div class="home-product">
							<div class="row sm-gutter">
								...
								$sqlmienbac = 'select count(ID) as number from pagemienbac'.$additional;
								$result = excuteResultMienBac($sqlmienbac);
								$number = 0;
								...
								$sqlmienbac = 'select * from pagemienbac where 1 '.$additional.' limit '.$index.', 15';
								$result = excuteResultMienBac($sqlmienbac);
								
								foreach ($result as $pagemienbac){
							
									echo '<a href="PageMienBac.php?id='.$pagemienbac['id'].'" class="col l-2-4 m-4 c-6">
									<div class="home-product-item">
									<img src="'.$pagemienbac['image'].'"class="home-product-item__img">
									<h4 class="home-product-item__name">'.$pagemienbac['title'].'</h4>
									<h5 class="home-product-item__location">'.$pagemienbac['introduce'].'</h5>
									<div class="home-product-item__action">
										<span class="home-product-item__like home-product-item__like--liked" style="color: #ff0b0b; font-weight: 500;">
											'.$pagemienbac['location'].'
										</span>
										<div class="home-product-item__rating">
											<i class="home-product-item__star--gold"></i>
										</div>
										<span class="home-product-item__sold">'.$pagemienbac['username'].'</span>
									</div>
									</div>
								</a>';
								...
								for ($i=1; $i <= $pages; $i++) { 
									if(!in_array($i, $avaiablePage)){
										if(!$isFirst && $current_page > 3){
											echo'<li class="pagination-item">
													<a href="?page='.($current_page-2).'" class="pagination-item__link">...</a>
												</li>';
											$isFirst = true;
										}
